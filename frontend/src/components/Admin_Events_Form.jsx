            ...
            <form id="eventForm">
                <div className="modal-body">
                    ...
                    <div className="form-group">
                        ...
                        <input type="url" id="eventImage" name="image" placeholder="https://example.com/image.jpg"/>
                        <img id="eventImagePreview" className="image-preview hidden" />
                    </div>
                    <div className="form-group">
                        <label for="eventLocation">Event Location</label>
                        <input type="text" id="eventLocation" name="location" placeholder="Community Center, Pune"/>
                    </div>
                </div>
