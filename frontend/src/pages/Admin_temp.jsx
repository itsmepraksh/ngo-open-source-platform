        ...
        <div className="sidebar " id="sidebar">
          ...
          {/* <ul className="nav-menu">
                <li className="nav-item">
                    <a href="#dashboard" className="nav-link  active" data-section="dashboard">
                        <i className="fas fa-tachometer-alt"></i>
                        Dashboard
                    </a>
                </li>
                <li className="nav-item">
                    <a href="#general" className="nav-link" data-section="general">
                ...
                <li className="nav-item">
                    <a href="#events" className="nav-link" data-section="events">
                        <i className="fas fa-calendar-alt"></i>
                        Events & Activities
                    </a>
                </li>
                <li className="nav-item">
                    <a href="#shop" className="nav-link" data-section="shop">
                        <i className="fas fa-shopping-cart"></i>
                        Support Products
                    </a>
                </li>
                <li className="nav-item">
                    <a href="#orders" className="nav-link" data-section="orders">
                ...
                <li className="nav-item">
                    <a href="#volunteers" className="nav-link" data-section="volunteers">
                        <i className="fas fa-users"></i>
                        Volunteer Applications
                    </a>
                </li>
                <li className="nav-item">
                    <a href="#donations" className="nav-link" data-section="donations">
